...
<a href="${relativeRoot}LoiReparation/index.html" class="nav-item ${currentPath.includes('/LoiReparation/') || document.body.classList.contains('loi-page') ? 'active' : ''}" title="Biblio">
